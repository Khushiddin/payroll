            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addPayment" action="<?php echo base_url() ?>addNewPaymentSave" method="post" role="form" enctype='multipart/form-data'>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
...
$(document).ready(function(){
    ...
    var validator = addAdvanceForm.validate({
        ...
        messages:{
            vendorId : { required : "This field is required"},

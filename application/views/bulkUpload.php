<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Upload Employees
            ...
            <div class="col-xs-12">
              <div class="box" style="overflow-x: scroll;
                ...
                <div class="box-header" style="height: 150px;">
                    <h3 class="box-title" style="margin-bottom: 40px;">Upload Bulk Employees</h3>
                    <div  style="margin-top: auto;top: auto;margin-right: 986px;">

                        <form method="POST" action="<?php echo base_url() ?>saveupload" id="csvForm" enctype="multipart/form-data">
                            <input type="file" name="userfile" required="" style="margin-bottom: 10px;">

                            <input type="submit" name="submit" value="Upload" >
                            <a href="<?php echo base_url(); ?>assets/bulkUsers.csv" class="btn btn-warning" download="">Sample Download</a>
                        </form>

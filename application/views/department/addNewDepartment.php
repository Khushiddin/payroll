            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addDepartment" action="<?php echo base_url() ?>addNewDepartmentSave" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="fname">Department Name</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('departmentName'); ?>" id="departmentName" name="departmentName" maxlength="128">
                                    </div>
